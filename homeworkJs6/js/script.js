...
function myClear(){
	...
	timer[0].innerText = time.toString();
  	mills[0].innerHTML = time.showMillisec();
  	clearInterval(intervalID);
}
...
buttonStart[0].addEventListener("click", myStart);

var buttonClear = document.getElementsByClassName('clear');
buttonClear[0].addEventListener("click", myClear);

var timer = document.getElementsByClassName('timer');
var mills = document.getElementsByClassName('millisec');
